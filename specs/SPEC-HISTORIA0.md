...
### User Story 0 - [Consultar disponibilidad del recurso] (Priority: P3) 
...
- **FR-003**: El sistema DEBE soportar [el filtrado de recursos por categoría (ej: "laptop", "microscopio", "workstation") y devolver el estado de disponibilidad actual para todos los recursos que coincidan con el filtro]
...
- **[Entity 2]**: [Espacio] [ID, nombre, aforo maximo, equipamiento{enlazado a activo}, ubicacion{enlazado a su propia entidad}, facultad{enlazado a su propia entidad} ]
- **[Entity 3]**: [tipo-Activo] [ID, nombre, descripcion] #####################NEEDS CLARIFICATION##########################
- **[Entity 4]**: [ubicacion-Espacio] [ID, nombre, descripcion]
...
- **FR-001**: Los usuarios (monitor de recursos y módulo 2) pueden consultar disponibilidad para cualquier recurso específico y recibir una respuesta en menos de 2 segundos bajo condiciones de carga normal (hasta 100 consultas concurrentes).

- **FR-002**: El sistema maneja exitosamente 500 consultas de disponibilidad concurrentes durante períodos de uso pico sin que la degradación de respuesta supere los 5 segundos.

- **FR-003**: El 95% de las consultas de disponibilidad devuelven información precisa y consistente cuando se validan contra el estado actual de la base de datos durante escenarios de prueba.
